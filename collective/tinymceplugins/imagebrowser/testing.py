...
def test_suite():
    return unittest.TestSuite([
        ...
        #    'README.txt', package='collective.tinymceplugins.imagebrowser',
        #    setUp=testing.setUp, tearDown=testing.tearDown),

        #doctestunit.DocTestSuite(
        #    module='collective.tinymceplugins.imagebrowser.mymodule',
        #    setUp=testing.setUp, tearDown=testing.tearDown),
        ...
        #    'browser.txt', package='collective.tinymceplugins.imagebrowser',
        #    test_class=TestCase),
